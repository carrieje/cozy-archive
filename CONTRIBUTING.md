# How to contribute to Cozy archive?
...
- What is the version of the Cozy Cozy archive?
...
```
$ git clone github.com/carrieje/cozy-archive.git
$ cd cozy-archive
$ git remote add fork git://github.com/yourusername/cozy-archive.git
```
...
Go to https://github.com/yourusername/cozy-archive and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy archive is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/carrieje/cozy-archive/issues/new
...
[localization]: https://github.com/carrieje/cozy-archive/blob/master/README.md#localization

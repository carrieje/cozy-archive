[![Travis build status shield](https://img.shields.io/travis/carrieje/cozy-archive/master.svg)](https://travis-ci.org/carrieje/cozy-archive)
[![Github Release version shield](https://img.shields.io/github/tag/carrieje/cozy-archive.svg)](https://github.com/carrieje/cozy-archive/releases)
...
Hacking the Cozy Cozy archive app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/carrieje/cozy-archive.git
$ cd cozy-archive
$ yarn install
```
...
$ docker run --rm -it -p 8080:8080 -v "$(pwd)/build":/data/cozy-app/cozy-archive cozy/cozy-app-dev
or
$ yarn stack:docker
```

your app is available at http://cozy-archive.cozy.tools:8080.
...
If you want to work on Cozy archive and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for Cozy archive is [carrieje](https://github.com/carrieje), send him/her a :beers: to say hello!
...
Cozy archive is developed by carrieje and distributed under the [AGPL v3 license][agpl-3.0].
